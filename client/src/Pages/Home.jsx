...
// react generic functional component
...
function Home() {
   ...
   const [searchText , setSearchText] = useState('This is text');
  ...
  return (
    <div>
      ...
      <div className='mt-10'>
         {loading ? (
          <div className='className="flex justify-center items-center'> <Loader /> </div>
         ) : (
          <>
             {searchText && (
